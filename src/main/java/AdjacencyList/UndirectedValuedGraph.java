...
public class UndirectedValuedGraph extends UndirectedGraph{
    ...
    public void addEdge(UndirectedNode x, UndirectedNode y, int cost) {
        getNodeOfList(x).getNeighbours().put(getNodeOfList(y), cost);
        getNodeOfList(y).getNeighbours().put(getNodeOfList(x), cost);
    }
    ...
    public static void main(String[] args) {
        ...
        al.addEdge(new UndirectedNode(0), new UndirectedNode(0), 3);
        System.out.println(al);
        al.removeEdge(new UndirectedNode(0), new UndirectedNode(0));
        System.out.println(al);
    }
}
