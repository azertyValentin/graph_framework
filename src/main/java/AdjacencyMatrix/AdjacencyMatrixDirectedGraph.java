...
public class AdjacencyMatrixDirectedGraph extends AbstractMatrixGraph<DirectedNode> implements IDirectedGraph {
	...
	public static void main(String[] args) {
		...
		System.out.println("Successor of node 1:");
		for (Integer integer : t) {
			System.out.print(integer + ", ");
		}
		System.out.println();
		System.out.println("Predecessor of node 2:");
		List<Integer> t2 = am.getPredecessors(new DirectedNode(2));
		for (Integer integer : t2) {
			System.out.print(integer + ", ");
		}
		System.out.println("\nArc 1;2 is here (should be true): "+am.isArc(new DirectedNode(1), new DirectedNode(2)));
		System.out.println("Removing arc 1;2 ....");
		am.removeArc(new DirectedNode(1), new DirectedNode(2));
		System.out.println("\nArc 1;2 is here (should be false): "+am.isArc(new DirectedNode(1), new DirectedNode(2)));
		System.out.println("Adding arc 1;2 ....");
		am.addArc(new DirectedNode(1), new DirectedNode(2));
		System.out.println("\nArc 1;2 is here (should be true): "+am.isArc(new DirectedNode(1), new DirectedNode(2)));
		System.out.println("Matrix Inverse :"+am.computeInverse());
	}
}
